 ...
 * Proporciona métodos CRUD estándar y consultas personalizadas para operaciones
 * con envíos.
 */
...
public interface EnvioRepository extends JpaRepository<Envio, Integer> {
    ...
    /**
     * Busca y devuelve una lista de envíos cuya fecha de entrega se encuentra
     ...
     * @return Una lista de entidades {@link Envio} que coinciden con el criterio de
     *         búsqueda.
     */
    @Query(value = "SELECT * FROM envio WHERE fecha_entrega BETWEEN :fechainicial AND :fechafinal", nativeQuery = true)
    List<Envio> buscarPorRangoDeFecha(@Param("fechainicial") LocalDate fechainicial,
